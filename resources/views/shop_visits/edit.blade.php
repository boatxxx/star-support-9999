        ...
        <div class="form-group">
            ...
            <select class="form-control" id="shop_id" name="shop_id" required>
                @foreach ($shops as $shop)
                    <option value="{{ $shop->shop_id }}" {{ (isset($shopVisit) && $shopVisit->shop_id == $shop->shop_id) ? 'selected' : '' }}>
                        {{ $shop->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="employee_id" name="employee_id" required>
                @foreach ($employees as $employee)
                    <option value="{{ $employee->user_id }}" {{ (isset($shopVisit) && $shopVisit->employee_id == $employee->user_id) ? 'selected' : '' }}>
                        {{ $employee->name }}
                    </option>
                @endforeach
            </select>
